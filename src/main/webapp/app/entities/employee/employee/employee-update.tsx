...
export const EmployeeUpdate = () => {
  ...
  const loading = useAppSelector(state => state.managementui.employee.loading);
  const updating = useAppSelector(state => state.managementui.employee.updating);
  const updateSuccess = useAppSelector(state => state.managementui.employee.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="managementUiApp.employeeEmployee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
