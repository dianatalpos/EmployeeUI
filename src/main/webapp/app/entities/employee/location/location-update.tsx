...
import { getEntities as getCountries } from 'app/entities/employee/country/country.reducer';
...
export const LocationUpdate = () => {
  ...
  const countries = useAppSelector(state => state.managementui.country.entities);
  const locationEntity = useAppSelector(state => state.managementui.location.entity);
  const loading = useAppSelector(state => state.managementui.location.loading);
  const updating = useAppSelector(state => state.managementui.location.updating);
  const updateSuccess = useAppSelector(state => state.managementui.location.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="managementUiApp.employeeLocation.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
