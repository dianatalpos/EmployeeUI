...
import { getEntities as getLocations } from 'app/entities/employee/location/location.reducer';
...
export const DepartmentUpdate = () => {
  ...
  const locations = useAppSelector(state => state.managementui.location.entities);
  const departmentEntity = useAppSelector(state => state.managementui.department.entity);
  const loading = useAppSelector(state => state.managementui.department.loading);
  const updating = useAppSelector(state => state.managementui.department.updating);
  const updateSuccess = useAppSelector(state => state.managementui.department.updateSuccess);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="managementUiApp.employeeDepartment.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
