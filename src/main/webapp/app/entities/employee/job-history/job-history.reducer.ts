...
import { IJobHistory, defaultValue } from 'app/shared/model/employee/job-history.model';
...
const apiUrl = 'services/employee/api/job-histories';
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IJobHistory, thunkAPI) => {
    const result = await axios.put<IJobHistory>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IJobHistory, thunkAPI) => {
    const result = await axios.patch<IJobHistory>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
