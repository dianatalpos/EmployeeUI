...
export const JobHistory = () => {
  ...
  const jobHistoryList = useAppSelector(state => state.managementui.jobHistory.entities);
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/job-history/${jobHistory.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
